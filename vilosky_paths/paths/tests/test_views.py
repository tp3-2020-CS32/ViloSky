...
class RegisterPageTests(TestCase):
    ...
    def test_register_form(self):
        user_form = UserForm(data={"username": "judy", "password": "pingpong1234", "email": "judy@email.com"})
        profile_form = UserProfileForm(data={"first_name": "Greg", "last_name":"Testy"})
        ...
        self.assertTrue(self.client.login(username="judy",password="pingpong1234"))
    
    def test_register_post(self):
        context = {"username": "judy", "password": "pingpong1234", "email": "judy@email.com", "first_name":"Greg", "last_name": "Testy"}
...
class LoginPageTests(TestCase):
    ...
    def setUpTestData(cls):
        user = User.objects.create(username="judy", first_name="Greg", last_name="Testy", email="judy@email.com")
    ...
    def test_login_post(self):
        ...
        response = self.client.post(reverse("paths:login"), {"username":"judy", "password":"pingpong1234"})
