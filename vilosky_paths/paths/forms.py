...
class SearchForm(forms.Form):
    ...
    work_place_barriers_tags = forms.ModelMultipleChoiceField(queryset=Tag.objects.filter(tag_categories="Current workplace barriers"), to_field_name="tag_name", required=False)
    ...
    industry_tags = forms.ModelMultipleChoiceField(queryset=Tag.objects.filter(tag_categories="Industries interested in"), to_field_name="tag_name", required=False)
